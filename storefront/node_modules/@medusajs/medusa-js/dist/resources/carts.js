...
var CartsResource = /** @class */ (function (_super) {
    ...
    CartsResource.prototype.addShippingMethod = function (cart_id, payload, customHeaders) {
        ...
        var path = "/store/carts/".concat(cart_id, "/shipping-methods");
    ...
    CartsResource.prototype.complete = function (cart_id, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
        var path = "/store/carts/".concat(cart_id, "/complete");
    ...
    CartsResource.prototype.createPaymentSessions = function (cart_id, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
        var path = "/store/carts/".concat(cart_id, "/payment-sessions");
        return this.client.request("POST", path, undefined, {}, customHeaders);
    };
    /**
    ...
    CartsResource.prototype.deleteDiscount = function (cart_id, code, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
        var path = "/store/carts/".concat(cart_id, "/discounts/").concat(code);
    ...
    CartsResource.prototype.deletePaymentSession = function (cart_id, provider_id, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
        var path = "/store/carts/".concat(cart_id, "/payment-sessions/").concat(provider_id);
        return this.client.request("DELETE", path, undefined, {}, customHeaders);
    };
    /**
    ...
    CartsResource.prototype.refreshPaymentSession = function (cart_id, provider_id, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
        var path = "/store/carts/".concat(cart_id, "/payment-sessions/").concat(provider_id, "/refresh");
        return this.client.request("POST", path, undefined, {}, customHeaders);
    };
    /**
     * Retrieves a cart
    ...
    CartsResource.prototype.retrieve = function (cart_id, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
        var path = "/store/carts/".concat(cart_id);
    ...
    CartsResource.prototype.setPaymentSession = function (cart_id, payload, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
        var path = "/store/carts/".concat(cart_id, "/payment-session");
        return this.client.request("POST", path, payload, {}, customHeaders);
    };
    /**
     * Updates a cart
