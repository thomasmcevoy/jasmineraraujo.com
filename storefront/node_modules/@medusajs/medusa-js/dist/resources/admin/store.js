...
var AdminStoresResource = /** @class */ (function (_super) {
     ...
     */
    AdminStoresResource.prototype.update = function (payload, customHeaders) {
     ...
     */
    AdminStoresResource.prototype.addCurrency = function (currency_code, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
        var path = "/admin/store/".concat(currency_code);
     ...
     * @returns updated store
     */
    AdminStoresResource.prototype.deleteCurrency = function (currency_code, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
        var path = "/admin/store/currencies/".concat(currency_code);
     ...
     */
    AdminStoresResource.prototype.retrieve = function (customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
        var path = "/admin/store/";
     ...
     */
    AdminStoresResource.prototype.listPaymentProviders = function (customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
     ...
     * @returns a list of payment providers configured on the store
     */
    AdminStoresResource.prototype.listTaxProviders = function (customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
        var path = "/admin/store/tax-providers";
        return this.client.request("GET", path, undefined, {}, customHeaders);
    };
