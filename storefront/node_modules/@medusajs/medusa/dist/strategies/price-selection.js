...
var PriceSelectionStrategy = /** @class */ (function (_super) {
    ...
    function PriceSelectionStrategy(_a) {
        var manager = _a.manager, moneyAmountRepository = _a.moneyAmountRepository;
    ...
    PriceSelectionStrategy.prototype.calculateVariantPrice = function (variant_id, context) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var moneyRepo, _b, prices, count, result, prices_1, prices_1_1, ma;
            var e_1, _c;
                ...
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        try {
                            ...
                            try {
                                if (prices_1_1 && !prices_1_1.done && (_c = prices_1.return)) _c.call(prices_1);
                            }
...
var isValidQuantity = function (price, quantity) {
    return ((0, utils_1.isDefined)(quantity) && isValidPriceWithQuantity(price, quantity)) ||
