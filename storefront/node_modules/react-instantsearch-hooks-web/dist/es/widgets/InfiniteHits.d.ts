...
export declare function InfiniteHits<THit extends BaseHit = BaseHit>({ showPrevious: shouldShowPrevious, cache, escapeHTML, showPrevious: userShowPrevious, transformItems, ...props }: InfiniteHitsProps<THit>): JSX.Element;
export {};
