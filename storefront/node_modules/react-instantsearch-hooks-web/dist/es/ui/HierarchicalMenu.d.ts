...
declare type HierarchicalMenuClassNames = {
    /**
...
declare type HierarchicalListProps = Pick<ReturnType<typeof useHierarchicalMenu>, 'items' | 'createURL'> & {
    className?: string;
...
export declare function HierarchicalMenu({ classNames, items, hasItems, onNavigate, createURL, showMore, canToggleShowMore, onToggleShowMore, isShowingMore, ...props }: HierarchicalMenuProps): JSX.Element;
export {};
