...
export declare type RefinementListClassNames = {
    /**
...
export declare function RefinementList({ canRefine, items, onRefine, query, searchBox, noResults, showMore, canToggleShowMore, onToggleShowMore, isShowingMore, className, classNames, ...props }: RefinementListProps): JSX.Element;
