...
export declare type MenuCSSClasses = {
    /**
...
export declare function Menu({ items, classNames, showMore, canToggleShowMore, onToggleShowMore, isShowingMore, createURL, onRefine, ...props }: MenuProps): JSX.Element;
