...
declare class RegionService extends TransactionBaseService {
    ...
    constructor({ manager, regionRepository, countryRepository, storeService, eventBusService, currencyRepository, paymentProviderRepository, fulfillmentProviderRepository, taxProviderRepository, paymentProviderService, fulfillmentProviderService, }: InjectedDependencies);
    /**
     * Creates a region.
     *
