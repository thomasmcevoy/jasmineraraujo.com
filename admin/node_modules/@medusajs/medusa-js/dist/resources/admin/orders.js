...
var AdminOrdersResource = /** @class */ (function (_super) {
    ...
    AdminOrdersResource.prototype.update = function (id, payload, customHeaders) {
        ...
        var path = "/admin/orders/".concat(id);
