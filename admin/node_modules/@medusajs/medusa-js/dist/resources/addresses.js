...
var AddressesResource = /** @class */ (function (_super) {
    __extends(AddressesResource, _super);
     ...
     */
    AddressesResource.prototype.addAddress = function (payload, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
        var path = "/store/customers/me/addresses";
     ...
     * @return {ResponsePromise<StoreCustomersRes>}
     */
    AddressesResource.prototype.deleteAddress = function (address_id, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
        var path = "/store/customers/me/addresses/".concat(address_id);
     ...
     */
    AddressesResource.prototype.updateAddress = function (address_id, payload, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
        var path = "/store/customers/me/addresses/".concat(address_id);
        return this.client.request("POST", path, payload, {}, customHeaders);
    };
...
exports.default = AddressesResource;
